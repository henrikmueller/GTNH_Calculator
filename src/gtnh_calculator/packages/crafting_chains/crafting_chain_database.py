...
class CraftingChainDatabase:
    ...
    def instantiate(
        self, recipe: Recipe, pick_any: bool = False, input_combinations: list[InputCombination] = [],
    ...
    def number_of_instantiated_recipes(self, recipes: Iterable[Recipe]) -> int:
        return sum(recipe.input_combination_amount for recipe in recipes)
